...
// use crate::{
//     inventory::{Inventory, Item, ItemDescriptor, Orientation, Shape, entry::Entry},
...
//     //     return;
//     // };
//     // let Some(mut inventory) = inventory_manager.open_inventory(click.inventory) else {
//     //     trace!("Inventory asset not found, ignoring drop");
//     //     return;
//     // };
//     // let Ok(item) = icons.get_mut(held.entity) else {
//     //     trace!("Item not found, ignoring drop");
//     //     return;
//     // };

//     // match inventory.add_item(icon.item, click.position, shape.orientation) {
//     //     Err(e) => {
